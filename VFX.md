...
| Posição Firme carregando | Placas âmbar travando no chão em volta da nave, uma por vez, como medidor da carga; espirais puxando energia para o núcleo cada vez mais rápido e fissuras vermelhas abrindo para fora conforme a nave fica exposta a projéteis (apaga em ~0,2 s assim que a nave anda) |
