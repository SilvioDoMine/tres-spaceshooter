...
export type TalentStat =
  ...
  | 'heartHealPercent'
  | 'levelUpHealPercent'
  | 'collisionReductionFlat'
  | 'collisionReductionPercent'
  | 'gearBaseStatsPercent'
  | 'battleGoldPercent'
...
export const TALENTS: TalentDefinition[] = [
  // Conjunto 1 — Lendários: liberam mecânicas (1 estrela)
  {
    ...
    icon: 'goblet',
    maxStars: 1,
    effects: [{ stat: 'startingSkillChoices', perStar: 1 }],
  },
  {
    id: 'taticas',
    name: 'Táticas',
    ...
    icon: 'book',
    maxStars: 1,
    effects: [{ stat: 'skillRerolls', perStar: 1 }],
  },
  ...
  // Conjunto 1 — Épicos (%)
  {
    ...
    maxStars: 5,
    effects: [
      { stat: 'moveSpeedPercent', perStar: 1 },
      { stat: 'attackSpeedPercent', perStar: 1 },
    ],
  },
  {
    id: 'refinamento',
    ...
    icon: 'emblem',
    maxStars: 5,
    effects: [{ stat: 'gearBaseStatsPercent', perStar: 2 }],
  },
  {
    id: 'riqueza',
    name: 'Riqueza',
    ...
    icon: 'apple',
    maxStars: 5,
    effects: [{ stat: 'battleGoldPercent', perStar: 4 }],
  },
  {
    id: 'ultra-taxa-crit',
    name: 'Ultra Taxa Crít.',
    rarity: 'epic',
    set: 1,
    icon: 'crosshair',
    maxStars: 5,
    effects: [{ stat: 'critRatePercent', perStar: 2 }],
  },
  {
    id: 'ultra-dano-crit',
    name: 'Ultra Dano Crít.',
    rarity: 'epic',
    set: 1,
    icon: 'rune',
    maxStars: 5,
    effects: [{ stat: 'critDamagePercent', perStar: 6 }],
  },
  {
    id: 'ultra-desvio',
    name: 'Ultra Desvio',
    ...
    icon: 'dash',
    maxStars: 5,
    effects: [{ stat: 'dodgePercent', perStar: 2 }],
  },
  ...
  // Conjunto 1 — Raros (%)
  {
    ...
    icon: 'armor',
    maxStars: 5,
    effects: [{ stat: 'maxHealthPercent', perStar: 2 }],
  },
  {
    id: 'super-forca',
    name: 'Super Força',
    ...
    icon: 'sword',
    maxStars: 5,
    effects: [{ stat: 'damagePercent', perStar: 2 }],
  },
  {
    id: 'super-recuperacao',
    name: 'Super Recuperação',
    rarity: 'rare',
    set: 1,
    icon: 'heart',
    maxStars: 5,
    effects: [{ stat: 'heartHealPercent', perStar: 4 }],
  },
  {
    id: 'super-muro-de-ferro',
    name: 'Super Muro de Ferro',
    rarity: 'rare',
    set: 1,
    icon: 'wall',
    maxStars: 5,
    effects: [{ stat: 'collisionReductionPercent', perStar: 2 }],
  },
  {
    id: 'cura',
    name: 'Cura',
    ...
    icon: 'potion',
    maxStars: 5,
    effects: [{ stat: 'levelUpHealPercent', perStar: 2 }],
  },
  {
    id: 'tita',
    name: 'Titã',
    ...
    maxStars: 5,
    effects: [
      { stat: 'maxHealthPercent', perStar: 1 },
      { stat: 'damagePercent', perStar: 1 },
      { stat: 'critDamagePercent', perStar: 2 },
    ],
  },
  {
    id: 'super-taxa-crit',
    name: 'Super Taxa Crít.',
    rarity: 'rare',
    set: 1,
    icon: 'crosshair',
    maxStars: 5,
    effects: [{ stat: 'critRatePercent', perStar: 1 }],
  },
  {
    id: 'super-dano-crit',
    name: 'Super Dano Crít.',
    rarity: 'rare',
    set: 1,
    icon: 'rune',
    maxStars: 5,
    effects: [{ stat: 'critDamagePercent', perStar: 3 }],
  },
  {
    id: 'super-desvio',
    name: 'Super Desvio',
    ...
    icon: 'dash',
    maxStars: 5,
    effects: [{ stat: 'dodgePercent', perStar: 1 }],
  },
  ...
  // Conjunto 1 — Comuns (fixo)
  {
    ...
    icon: 'armor',
    maxStars: 5,
    effects: [{ stat: 'maxHealthFlat', perStar: 10 }],
  },
  {
    id: 'forca',
    name: 'Força',
    ...
    icon: 'sword',
    maxStars: 5,
    effects: [{ stat: 'damageFlat', perStar: 2 }],
  },
  {
    id: 'recuperacao',
    name: 'Recuperação',
    ...
    icon: 'heart',
    maxStars: 5,
    effects: [{ stat: 'heartHealFlat', perStar: 5 }],
  },
  {
    id: 'muro-de-ferro',
    name: 'Muro de Ferro',
    ...
    icon: 'wall',
    maxStars: 5,
    effects: [{ stat: 'collisionReductionFlat', perStar: 3 }],
  },
  ...
  // Conjunto 2 — Comuns reforçados (fixo)
  {
    ...
    badge: 'II',
    maxStars: 5,
    effects: [{ stat: 'damageFlat', perStar: 4 }],
  },
  {
    id: 'vigor-ii',
    name: 'Vigor II',
    ...
    badge: 'II',
    maxStars: 5,
    effects: [{ stat: 'maxHealthFlat', perStar: 20 }],
  },
  {
    id: 'recuperacao-ii',
    name: 'Recuperação II',
    ...
    badge: 'II',
    maxStars: 5,
    effects: [{ stat: 'heartHealFlat', perStar: 10 }],
  },
  {
    id: 'muro-de-ferro-ii',
    name: 'Muro de Ferro II',
    rarity: 'common',
    set: 2,
    icon: 'wall',
    badge: 'II',
    maxStars: 5,
    effects: [{ stat: 'collisionReductionFlat', perStar: 6 }],
  },
];
