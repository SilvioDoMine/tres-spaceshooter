...
.lobby-screen--blue {
  --band: linear-gradient(#2f6fc4, #24569e);
  --title-tint: #cfe8ff;
  --pill-edge: #1d4a88;
  background: linear-gradient(#4aa3ec 0%, #2d6fbf 30%, #1d3566 60%, #161f3f 100%);
}
.lobby-screen--purple {
  --band: linear-gradient(#5a45b8, #4a389e);
  --title-tint: #dcd0ff;
  --pill-edge: #3b2a86;
...
.lobby-screen__title span {
  color: transparent;
  background: linear-gradient(#fff 40%, var(--title-tint));
  -webkit-background-clip: text;
  background-clip: text;
  filter: drop-shadow(0 2px 0 var(--pill-edge)) drop-shadow(0 -1px 0 var(--pill-edge))
    drop-shadow(1.5px 0 0 var(--pill-edge)) drop-shadow(-1.5px 0 0 var(--pill-edge))
    drop-shadow(0 4px 6px rgba(0, 0, 0, 0.3));
}
.lobby-screen__title i {
  font-style: normal;
  font-size: 0.5em;
  color: #ffd27a;
  filter: drop-shadow(0 2px 0 var(--pill-edge));
}
/* Separador: linha que clareia no centro com um losango */
.lobby-screen__divider {
  position: absolute;
  left: 10%;
  right: 10%;
  bottom: -10px;
...
.lobby-screen__divider i {
  ...
  background: linear-gradient(135deg, #ffd27a, #f08a1c);
  box-shadow: 0 0 0 2px var(--pill-edge);
}
.lobby-screen__header-start {
  position: absolute;
  left: 0;
  top: calc(100% + 12px);
}
...
.lobby-screen__body.has-footer {
  padding-bottom: 128px;
}
.lobby-screen__footer {
  position: absolute;
  left: 0;
  right: 0;
  bottom: 0;
...
.lobby-screen__empty span {
  font-size: 40px;
  color: #ffe09a;
}
.lobby-screen__empty p {
  margin: 0;
  font-size: 20px;
}
