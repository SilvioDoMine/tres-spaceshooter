    ...
    <div v-else class="tcard tcard--back" aria-label="Talento ainda não obtido">
      <div class="tcard__art">
        <svg class="tcard__back" viewBox="0 0 60 80" aria-hidden="true">
          <path
            d="M8 4v8M4 8h8M52 4v8M48 8h8M8 68v8M4 72h8M52 68v8M48 72h8"
            stroke="rgba(255,255,255,.45)"
            stroke-width="2"
            stroke-linecap="round"
          />
          <path
            d="M30 8 54 40 30 72 6 40z"
            fill="none"
...
.tcard {
  ...
  box-shadow:
    0 3cqw 0 var(--frame-dark),
    0 5cqw 9cqw rgba(0, 0, 0, 0.3);
}
.tcard--rare {
  --frame: #6cc0fa;
  --frame-dark: #2767ad;
...
.tcard__art {
  ...
  overflow: hidden;
  border-radius: 6cqw;
  border: 1.8cqw solid var(--frame-dark);
  background:
    repeating-conic-gradient(from -6deg at 50% 40%, rgba(255, 255, 255, 0.13) 0 10deg, transparent 10deg 30deg),
...
.tcard__icon {
  ...
  height: 68cqw;
  translate: -50% -50%;
  filter: drop-shadow(0 2cqw 0 rgba(0, 0, 0, 0.25));
}
.tcard__badge {
  position: absolute;
  top: 4cqw;
...
.tcard__ribbon {
  ...
  border: 1.5cqw solid var(--frame-dark);
  box-shadow:
    0 2cqw 0 rgba(0, 0, 0, 0.25),
    inset 0 1.5cqw rgba(255, 255, 255, 0.35);
}
.tcard__ribbon span {
  font:
    11cqw/1 'Lilita One',
...
.tcard__star {
  ...
  stroke-width: 1.6;
  stroke-linejoin: round;
  filter: drop-shadow(0 1cqw 0 rgba(0, 0, 0, 0.3));
}
