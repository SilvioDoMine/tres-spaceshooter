    ...
    >
        ...
        <div class="flex flex-col gap-4">
                ...
                <BaseInset class="flex gap-2 items-center w-full p-2">
                    ...
                    <BaseInset variant="sunken" class="p-2 flex flex-col flex-1">
                ...
                <div class="flex flex-col gap-2">
                   <!-- Box-->
                    <BaseInset variant="dark" class="grid p-2 gap-2 grid-cols-4 items-center justify-items-center">
                        <!-- Image -->
                        <div 
                   ...
                   <!-- Unlock description -->
                   <BaseInset variant="dark" class="p-2">
