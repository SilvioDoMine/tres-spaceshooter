  ...
  <div class="absolute top-0 mt-8 left-0 z-10 flex flex-col gap-4 w-full pointer-events-none">
    <div class="mx-auto flex flex-col items-center gap-2">
      <div class="flex flex-col items-center">
         <div class="text-white text-[9px] font-bold px-6 line-clamp-1 bg-white/20 rounded-t-lg">Nave Nv. {{ currentRunStore.currentLevel }}</div>
      ...
      <!-- Room Number: 3 -->
      <div v-if="showRoom" class="text-white text-sm px-4 bg-white/20 rounded-full flex items-center justify-center gap-2">
        <!-- Icon sword -->
        ...
        <span>Sala {{ currentRoom }}/{{ totalRooms }}</span>
      </div>
    </div>
  </div>
</template>
