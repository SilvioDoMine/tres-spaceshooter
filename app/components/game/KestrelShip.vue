...
<template><TresGroup><primitive :object="hull.root" /><GameShipEquipment :gameplay="props.gameplay" :preview="props.preview" /><GameEnginePlumes v-if="settings.thrusters" :preview="props.preview" /></TresGroup></template>
