...
<template>
    <div :class="currentRunStore.isPaused ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'" class="absolute z-50 translate-all duration-500 inset-0 p-4 text-white bg-black/50">
