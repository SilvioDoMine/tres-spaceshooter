...
const missionsModal = useModal('missions-modal');
  ...
  <div id="lobby-stuff" class="w-full h-full absolute top-0 left-0 right-0 bottom-0 pointer-events-none">
    ...
    <div class="relative w-full h-full">
      ...
      <div class="lobby-actions absolute bottom-30 left-0 w-full flex items-end justify-center gap-4 px-4 pointer-events-none">
        ...
        <button type="button" aria-label="Equipamento" class="lobby-side lobby-side--left lobby-side--equip">
          <svg class="lobby-side__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
            <path d="M32 4 9 12v17c0 15.5 9.8 26.8 23 31 13.2-4.2 23-15.5 23-31V12z" fill="#dfe7f2" stroke="#16305a" stroke-width="3" stroke-linejoin="round"/>
            <path d="M32 11 15 17v12c0 11.6 7 20.4 17 24 10-3.6 17-12.4 17-24V17z" fill="#3a8ae0"/>
            <path d="M32 11 15 17v12c0 11.6 7 20.4 17 24z" fill="#fff" opacity=".22"/>
            <path d="m32 20 3.6 7.4 8.1 1.1-5.9 5.7 1.4 8.1L32 38.5l-7.2 3.8 1.4-8.1-5.9-5.7 8.1-1.1z" fill="#ffd35a" stroke="#8a5200" stroke-width="1.5" stroke-linejoin="round"/>
          </svg>
      ...
      >
        ...
        <button type="button" aria-label="Talentos" class="lobby-side lobby-side--right lobby-side--talent">
          <svg class="lobby-side__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
            <path d="M32 6 39.1 23.8 58 25l-14.6 12.2L48 56 32 45.8 16 56l4.6-18.8L6 25l18.9-1.2z" fill="#ffd35a" stroke="#7a4300" stroke-width="3" stroke-linejoin="round"/>
            <path d="M32 14 36.6 26.4 49 27.2l-9.6 8 3 12.3L32 40.8z" fill="#fff" opacity=".3"/>
            <circle cx="32" cy="32" r="6" fill="#b06cff" stroke="#4a2690" stroke-width="2"/>
            <path d="M54 6v8M50 10h8M9 44v6M6 47h6" stroke="#fff" stroke-width="2.5" stroke-linecap="round"/>
          </svg>
      ...
      <ClientOnly>
        ...
        <LobbyOffersModal @openRewards="handleOpenRewards" />
...
@media(max-width:650px){
 ...
 .lobby-actions{bottom:78px;justify-content:space-between;gap:8px;padding:0}.chapter-start{flex:1 1 auto}.chapter-start button{height:56px}.chapter-start button .text-3xl{font-size:24px}.chapter-return{bottom:92px;padding:0 104px}.chapter-return p{font-size:11px}
...
@media(max-height:500px) and (orientation:landscape){
 ...
 .lobby-actions{left:auto;right:1%;bottom:24px;width:44%;gap:6px;padding:0 6px;justify-content:center}.chapter-start button{height:55px}.lobby-side{width:68px;height:55px;padding-bottom:4px;border:3px solid;border-radius:12px}.lobby-side__icon{top:-16px;width:40px;height:40px}.lobby-side__label{font-size:9px;padding:1px 3px}.chapter-return{left:auto;right:2%;transform:none;bottom:35px;width:42%;padding:0}.chapter-return p{font-size:10px}
}
