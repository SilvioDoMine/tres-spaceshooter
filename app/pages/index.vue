    ...
    <div class="relative w-full h-full">
      ...
      <div class="absolute top-24 w-full flex px-2 flex-row justify-between pointer-events-none">
        ...
        <div class="flex flex-col gap-2">
          <!-- Settings -->
          <div class="p-2 bg-white/20 rounded-lg inline-flex items-center justify-center cursor-pointer pointer-events-auto hover:bg-white/20 transition">
          ...
          <div class="aspect-square relative bg-white/20 rounded-lg flex-col flex items-center justify-center cursor-pointer pointer-events-auto hover:bg-white/20 transition">
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="aspect-square relative bg-white/20 rounded-lg flex-col flex items-center justify-center cursor-pointer pointer-events-auto hover:bg-white/20 transition">
           ...
           <!-- Missões -->
          <div class="bg-white/20 rounded-lg flex-col flex items-center justify-center cursor-pointer pointer-events-auto hover:bg-white/20 transition">
