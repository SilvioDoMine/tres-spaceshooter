...
// Page metadata
useHead({
  title: 'Lobby - Hyfight Spaceshooter',
  meta: [
    { name: 'description', content: 'Hyfight Spaceshooter: pilote a Kestrel-07 e limpe as salas capítulo por capítulo.' }
  ]
})
